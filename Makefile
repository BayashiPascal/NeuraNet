...
INCPATH=-I./ -I$(PBERRDIR)/ -I$(PBMATHDIR)/ -I$(GENALGDIR)/ -I$(GSETDIR)/
...
main: main.o pberr.o neuranet.o pbmath.o genalg.o gset.o Makefile 
	$(COMPILER) main.o pberr.o neuranet.o pbmath.o genalg.o gset.o $(LINKOPTIONS) -o main
